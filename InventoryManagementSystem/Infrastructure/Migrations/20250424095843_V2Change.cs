        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseOrder_SupplierID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SalesOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ItemId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerItems", x => x.CustomerItemId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerItems_SalesOrderId",
                table: "CustomerItems",
                column: "SalesOrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupplierItems_PurchaseOrderId",
                table: "SupplierItems",
